...
class Task(models.Model):
    ...
    misto = models.CharField('Name', max_length=50)  # Field to 255 chars
    gruz = models.CharField('Description', max_length=10, choices=GRUZ_CHOICES)
    litres = models.CharField('Litres', max_length=20)
    price = models.CharField('Price', max_length=25)
    massa = models.CharField('Massa', max_length=50)
    punkt = models.CharField('Punkt', max_length=50)
    date = models.DateTimeField(default=timezone.now)

    derzh_nomer = models.CharField('derzh_nomer', max_length=50)
    ttn_nomer = models.CharField('ttn_nomer', max_length=50)
    skilki_vantazhu = models.CharField('skilki_vantazhu', max_length=50)
    odometr_vizd = models.CharField('odometr_vizd', max_length=50)
    odometr_viezd = models.CharField('odometr_viezd', max_length=50)
    zaprawka_time = models.CharField('zaprawka_time', max_length=50)
